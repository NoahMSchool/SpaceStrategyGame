...
static var teams = [
	...
	Team.new(0, "YellowEnergyAliens", Color(1.274, 1.274, 0.518, 1.0)),
	Team.new(0, "SpaceYetis", Color(0.549, 0.673, 0.846, 1.0)),
	Team.new(0, "BugBugs", Color(0.387, 0.0, 0.659, 1.0)),
